...
class Stage6UnitTest : PhotoEditorUnitTest<MainActivity>(MainActivity::class.java) {
    ...
    companion object {
        ...
        const val MESSAGE_SYNCHRONOUS_CODE = "Are your filters being applied asynchronously?"
    ...
    fun test01_checkHighBrightnessValue() {
        testActivity {
            ...
            assertColorsValues(MESSAGE_SYNCHRONOUS_CODE, initialRgb, actualRgb0, MARGIN_ERROR)
    ...
    fun test07_checkDefaultBitmapEditWiderSample() {
        testActivity {
            ...
            for (i in sample.indices) {
                ...
                assertColorsValues(
                    "$MESSAGE_SYNCHRONOUS_CODE For x=${point.first}, y=${point.second}",
                    expectedBefore[i], actual, MARGIN_ERROR
                )
            }
            ...
            for (i in sample.indices) {
                ...
                assertColorsValues(
                    ...
                    expectedAfter[i], actual, MARGIN_ERROR
                )
            }
        }
    }

...
class Stage5UnitTest : PhotoEditorUnitTest<MainActivity>(MainActivity::class.java) {
    ...
    fun test05_checkSaturationOnlyWithHints() {
        testActivity {
            ...
            assertColorsValues(
                "$MESSAGE_WRONG_VALUES For x=70, y=60, avgBrightness=129, cAlpha=1.0, rgbAvg=133, sAlpha=0.7894",
                expectedRgb,
                actualRgb,
                MARGIN_ERROR
            )
    ...
    fun test07_checkGammaOnlyWithHints() {
        testActivity {
            ...
            val actualRgb = singleColor(actualImage, 70, 60)
            assertColorsValues(
                "$MESSAGE_WRONG_VALUES For x=70, y=60, avgBrightness=129, cAlpha=1.0, rgbAvg=133, sAlpha=1.0",
                expectedRgb,
                actualRgb,
                MARGIN_ERROR
            )
